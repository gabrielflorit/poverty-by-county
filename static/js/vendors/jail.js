(function(e, t) {
    ...
    function s(e, n) {
        var r = !1;
        !n || (r = n.data("triggerElem")), !!r && typeof r.bind == "function" && (r.bind(e.event, {options: e,images: n}, u), t.bind("resize", {options: e,images: n}, u))
    }
    function o(e) {
        var t = 0;
        if (e.length === 0)
    ...
    function l(e, t, n) {
        var r = e[0] === window, i = r ? {top: 0,left: 0} : e.offset(), s = i.top + (r ? e.scrollTop() : 0), o = i.left + (r ? e.scrollLeft() : 0), u = o + e.width(), a = s + e.height(), f = t.offset(), l = t.width(), c = t.height();
    ...
    var t = e(window), n = {timeout: 1,effect: !1,speed: 400,triggerElement: null,offset: 0,event: "load",callback: null,callbackAfterEachImage: null,placeholder: !1,loadHiddenImages: !1}, r = [], i = !1;
    return e.jail = function(t, r) {
        ...
        var n = this;
        t.triggerElement ? s(t, n) : n.bind(t.event, {options: t,images: n}, function(t) {
